...
from common.libs.Helper import selectFilterObj, getDictFilterField, geneTime
...
def myOrderList():
    ...
    print('pay_order_list',pay_order_list)
    data_pay_order_list = []
    if pay_order_list:
        ...
        if pay_order_item_list:
            for item in pay_order_item_list:
                ...
                pay_order_item_map[item.pay_order_id].append({
                    ...
                    'pic_url': UrlManager.buildImage(tmp_food_info.main_image),
