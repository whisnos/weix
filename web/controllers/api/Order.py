    ...
    if food_list:
        for item in food_list:
            tmp_data = {
                ...
                'pic_url': UrlManager.buildImage(item.main_image),
...
def orderCreate():
    ...
    express_address_id = int(req['express_address_id']) if 'express_address_id' in req and req.get(
        'express_address_id') != 'undefined' else 0
    params_goods = req['goods'] if 'goods' in req else None
