...
Revision ID: df86b7dd0819
Revises: 
Create Date: 2019-07-04 10:22:57.570871
...
def upgrade():
    ...
    sa.Column('referer_url', sa.String(length=255), nullable=False),
    ...
    op.create_index(op.f('ix_app_access_log_uid'), 'app_access_log', ['uid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_app_access_log_uid'), table_name='app_access_log')
