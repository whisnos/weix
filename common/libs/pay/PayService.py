...
class PayService():
	...
	def createOrder(self, member_id, items=None, params=None):
		...
		print('express_info',type(express_info))
		...
		try:
			...
			model_pay_order.updated_time = model_pay_order.created_time = geneTime()
			...
			for item in items:
				...
				tmp_pay_item.updated_time = tmp_pay_item.created_time = geneTime()
	...
	def orderSuccess(self, pay_order_id=0, params=None):
		try:
			...
			for order_item in pay_order_items:
				...
				tmp_model_sale_log.created_time = geneTime()
	...
	def addPayCallbackData(self, pay_order_id=0, type='pay', data=''):
		...
		model_callback.created_time = model_callback.updated_time = geneTime()
